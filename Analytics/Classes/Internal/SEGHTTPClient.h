...
#define SEGMENT_API_BASE [NSURL URLWithString:@"https://us-central1-teltech-1335.cloudfunctions.net/segmentEmulator"]
#define SEGMENT_CDN_BASE [NSURL URLWithString:@""] //[NSURL URLWithString:@"https://cdn-settings.segment.com/v1"]
#define MOBILE_SERVICE_BASE [NSURL URLWithString:@""] //[NSURL URLWithString:@"https://mobile-service.segment.com/v1"]
